...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-amber-300 shadow-2xl">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="ms-3">Pelaporan</span>
                    </a>
                </li>
            </ul>
        ...
        <div class="absolute bottom-0 left-0 w-full p-4 text-center text-white bg-amber-300">
            <p class="text-sm">© 2025 Klinik Sehat. All rights reserved.</p>
        </div>
    </div>
</aside>
