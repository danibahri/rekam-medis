...
@section('title', 'Tambah Data Status Pernikahan')
@section('description', 'Tambah Data Status Pernikahan - Rekam Medis')
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="rounded-lg border-2 border-dashed border-gray-200 p-4">
            <h1 class="mb-4 rounded bg-white py-5 pl-3 text-3xl font-bold text-gray-700 shadow">Tambah Data Status Pernikahan
            </h1>
            <div class="rounded-lg bg-white p-6 shadow">
                <form action="{{ route('master.status-pernikahan.store') }}" method="POST">
                    @csrf
                    <div class="mb-6">
                        ...
                        <input type="text" id="nama" name="nama"
                            ...
                            placeholder="Masukkan nama status pernikahan" value="{{ old('nama') }}" required>
                        @error('nama')
