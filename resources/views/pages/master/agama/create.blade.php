...
@section('description', 'Tambah Data Agama - Rekam Medis')
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="rounded-lg border-2 border-dashed border-gray-200 p-4">
            <h1 class="mb-4 rounded bg-white py-5 pl-3 text-3xl font-bold text-gray-700 shadow">Tambah Data Agama</h1>
                ...
                <form action="{{ route('master.agama.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="nama" name="nama"
                            ...
                            placeholder="Masukkan nama agama" value="{{ old('nama') }}" required>
                        @error('nama')
