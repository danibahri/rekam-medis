...
@section('description', 'Tambah Data Obat - Rekam Medis')
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="rounded-lg border-2 border-dashed border-gray-200 p-4">
            <h1 class="mb-4 rounded bg-white py-5 pl-3 text-3xl font-bold text-gray-700 shadow">Tambah Data Obat</h1>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="bentuk_sediaan" name="bentuk_sediaan"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-amber-400 focus:ring-amber-400"
                                placeholder="Masukkan bentuk sediaan" value="{{ old('bentuk_sediaan') }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" id="kekuatan" name="kekuatan"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-amber-400 focus:ring-amber-400"
                                placeholder="Masukkan kekuatan" value="{{ old('kekuatan') }}" required>
                            @error('kekuatan')
                                <span class="text-xs text-red-400">{{ $message }}</span>
                            @enderror
                        </div>
