...
@foreach ($data_pasien as $item)
    <div id="modal-{{ $item->nomor_rekam_medis }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="jenis_kalamin" class="mb-2 block text-sm font-medium text-gray-900">Jenis
                                Kelamin</label>
                            <input type="text" name="jenis_kalamin" id="jenis_kalamin"
                                ...
                                <table class="border-t-1 w-full text-left text-sm text-gray-700 shadow-md">
                                    ...
                                    <tbody>
                                        @if (count($kunjungan) == 0)
                                            <tr>
                                                <td colspan="4" class="px-6 py-4 text-center">Tidak ada antrian
                                                    pasien.
                                                </td>
                                            </tr>
                                        @else
                                            @foreach ($kunjungan as $kunjungan)
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4">{{ $kunjungan->keluhan_utama ?? '-' }}
                                                    </td>
                                                    <td class="px-6 py-4">
